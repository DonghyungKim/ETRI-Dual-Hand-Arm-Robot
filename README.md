...
*A demo of the robot grasping objects with each arm separately. Please note that this example is not included in this repository, and robot manipulation or motion planning is up to the user.*
...
#### Command message converter (/etri_dualarm_cmd_msg_converter_sim)
: ROS 2 package that converts the user's joint commands into suitable joint commands for Isaac Sim.
